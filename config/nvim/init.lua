...
-- Netrw
g.netrw_banner = 0 -- disable banner (0 turns it on)
g.netrw_liststyle = 3 -- tree style list
g.netrw_browse_split = 3 -- open file in new tab on CR
g.netrw_altv = 0 -- split to the right
g.netrw_winsize = 25 -- percentage of window
g.netrw_keepdir = 1 -- don't change pwd when browsing in tree
g.netrw_localrmdir = 'rm -r' -- command used to remove local dir
g.netrw_hide = 0 -- show dotfiles 
g.netrw_preview = 1 -- shows previews but I'm not sure where I see these yet
g.netrw_sizemode = 0 -- sort by name (0) or size (1)
